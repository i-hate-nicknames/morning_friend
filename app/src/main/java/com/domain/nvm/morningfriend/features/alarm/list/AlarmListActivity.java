package com.domain.nvm.morningfriend.features.alarm.list;
...
import com.domain.nvm.morningfriend.features.alarm.detail.AlarmDetailActivity;
import com.domain.nvm.morningfriend.features.training.SelectPuzzleActivity;
import com.domain.nvm.morningfriend.features.log.LogActivity;
import com.domain.nvm.morningfriend.features.log.Logger;
import com.domain.nvm.morningfriend.R;
import com.domain.nvm.morningfriend.features.settings.SettingsActivity;
...
public class AlarmListActivity extends AppCompatActivity {
    ...
    private void updateUI() {
        ...
        if (closest != null) {
            ...
            mNextAlarm.setText(DateTimeUtils.formatRemainingTime(timeDiff));
        }
    ...
    private class AlarmsHolder extends RecyclerView.ViewHolder
        ...
        public void bindAlarm(Alarm alarm) {
            isBinding = true;
            this.mAlarm = alarm;
            mRepeatDays.setText(DateTimeUtils.formatRepeatingDays(AlarmListActivity.this,
                    alarm.getRepeatDays()));
            mTimeTextView.setText(DateTimeUtils.formatTime(alarm.getHour(), alarm.getMinute()));
